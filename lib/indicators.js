...
const INDICATOR_QUERIES = [
  {
    name: 'payku.slo.payout.service.all.CLP.approval_rate',
    type: 'custom.googleapis.com/payku/slo',
    valueType: 'DOUBLE',
    unit: '%',
    ...
    sql: `
      SELECT
        ...
        SUM(CASE WHEN r.more_status <> 2 THEN 1 ELSE 0 END) AS no_success,
        ROUND(
  ...
  {
    name: 'payku.slo.payout.service.all.CLP.success_rate',
    type: 'custom.googleapis.com/payku/slo',
    valueType: 'DOUBLE',
    unit: '%',
